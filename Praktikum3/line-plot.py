...
option = st.sidebar.selectbox("Pilih Tipe VIsualisasi", ("Line Plot", 
                                                         "Kostumisasi Line Plot", 
                                                         "Garis Berbeda untuk menunjukan Trend",
                                                         "Subplot"))

#   identitas kelompok
st.caption("Praktikum 3 - kelompok 6")
st.markdown("""
            Kelompok 6:
...
def line_plot():
    ...
    ax.plot(months, product_B_sales)
...
def subplots():
    ...
    # Plot for Product A (grafik atas)
    ...
    # Plot for Product B (grafik bawah)
    ...
    plt.tight_layout()  # Biar tidak saling tumpang tindih
    st.pyplot(fig)

if option == "Line Plot":
    line_plot()

elif option == "Kostumisasi Line Plot":
    customize_line_plot()

elif option == "Garis Berbeda untuk menunjukan Trend":
    trend_lines_plot()
