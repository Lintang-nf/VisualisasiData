...
# 3. grafik custom stacked vertical bar chart
st.subheader("3. Kostumisasi Stacked Vertical Bar Chart dengan Matplotlib")
...
st.subheader("4. Multiple Stacked Vertical Bar Chart dengan Matplotlib")
